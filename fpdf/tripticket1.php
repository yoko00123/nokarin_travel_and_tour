...
require('fpdf.php');
   ...
   // $opaddress = $_POST['opaddress'];
	...
	if(isset($_GET['mydrivers'])){
		$drivername = $_GET['mydrivers'];
		$_SESSION['mydrivers'] = $drivername;
	}else{$drivername = "-";}
...
//ORDER BY ID DESC
  $sql = "SELECT * FROM `tTripTicketIssued` WHERE IsActive = 1 AND IsExpire = 0 AND Code <>'' AND ID_Operator = $opid";
  $result3 = mysqli_query($db, $sql);
	 ...
	 $sql8 = "SELECT * FROM `nokarin_drivers` WHERE ID = $ID_Driver";
...
$pdf->Cell(50, 5, $bodytype, 1, 0, 'L', true);
$pdf->Ln(5);
...
$pdf->Cell(50, 5, $platenumber, 1, 0, 'L', true);
$pdf->Ln(5);
...
$pdf->Ln(5);
$pdf->SetDrawColor(0,0,0);
$pdf->Cell(30, 5, "Passenger", 1, 0, 'L', true);

$pdf->SetFont('Arial','',4);
$pdf->Cell(10, 5, "Temperature", 1, 0, 'L', true);
$pdf->SetFont('Arial','',8);
$pdf->Cell(22.5, 5, "ORIGIN", 1, 0, 'L', true);
$pdf->Cell(22.5, 5, 'DESTINATION', 1, 0, 'C', true);
$pdf->Cell(15, 5, "IN", 1, 0, 'L', true);
$pdf->Cell(15, 5, "OUT", 1, 0, 'L', true);
$pdf->Cell(15, 5, "START", 1, 0, 'L', true);
$pdf->Cell(15, 5, "END", 1, 0, 'L', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);

$pdf->SetFont('Arial','',5);
$pdf->Cell(15, 5, "PAX'S SIGNATURE", 1, 0, 'C', true);

$pdf->SetFont('Arial','',8);
$pdf->Ln(5);
$pdf->Cell(30, 5, "", 1, 0, 'L', true);
$pdf->Cell(10, 5, "", 1, 0, 'L', true);
$pdf->Cell(22.5, 5, "", 1, 0, 'L', true);
$pdf->Cell(22.5, 5, '', 1, 0, 'C', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);
$pdf->Cell(15, 5, "", 1, 0, 'L', true);
