  ...
  <div class="col-75">
    <div class="container">
      <form>
        ...
        <label>
          <input type="checkbox" checked="checked" name="sameadr">I am the driving my own unit.
        </label>
        <input type="submit" value="Request to Nokarin" class="btn">
      </form>
    </div>
  </div>
  <div class="col-25">
