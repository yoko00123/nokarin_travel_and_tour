...
<ul>
  ...
  <li class="dropdown">
    ...
    <?php if($ID_UserTypeLatest == 5 || $ID_UserTypeLatest == 1){?>
    <li class="dropdown">
    <a href="members" class="dropbtn">Reports</a>
    <div class="dropdown-content">
      <a href="collist">COL List</a>
      <a href="triptickets">Trip Tickets</a>
      <a href="weeklysummarytrans">Weekly Transportation Summary Report</a>
      <a href="cashvoucher">Cash Vouchers</a>
    </div>
  </li>
  <?php } ?>
  <li class="dropdown">
